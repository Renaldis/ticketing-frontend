      ...
      <main className="p-6 sm:p-10 space-y-8 flex-1">
        <div className="premium-card rounded-2xl p-6 sm:p-8 space-y-6 shadow-2xl">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h2 className="text-xl font-bold text-white">Log Transaksi ({filteredOrders.length})</h2>
              <p className="text-xs text-[#908fa0]">Seluruh riwayat transaksi pelanggan di semua event</p>
            </div>
